 ...
 app.get('/installation_storage', (req, res) => {
    res.render('installation_storage', { title: 'Solanki Industries' }); 
});
...
// Route for the certification page
 app.get('/certification', (req, res) => {
    res.render('certification', { title: 'Solanki Industries' }); 
});
...
// Route for the gallery page
 app.get('/gallery', (req, res) => {
    res.render('gallery', { title: 'Solanki Industries' }); 
});
